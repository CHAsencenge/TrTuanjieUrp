...
namespace UnityEngine.Rendering.Universal
{
    ...
    public enum DebugFullScreenMode
    {
        ...
        /// <summary>
        /// Display the shading rate values used for the objects rendering.
        /// </summary>
        ShadingRateValueMap,
        /// <summary>
        /// Displays the active Tuanjie Super Resolution PostProcess debug view.
        /// </summary>
        TJSR,
    }
    ...
    #region GDRP settings

    /// <summary>
    /// Debug modes for GDRP.
    /// </summary>
    [GenerateHLSL]
    public enum DebugBufferVisualization
    {
        None,
        ClusterID,
        InstanceID,
    ...
    [GenerateHLSL]
    public enum DebugVirtualShadowMapVisualization
    {
        None,
