...
namespace ShaderStrippingAndPrefiltering
{
    class ShaderPrefilteringTests
    {
        class TestHelper
        {
            ...
            {
                Assert.AreEqual(expected.clusteredLightingPrefilteringMode, actual.clusteredLightingPrefilteringMode, "forwardPlusPrefilteringMode mismatch");
        ...
        public void TestCreatePrefilteringSettings_RenderingModes()
        {
            ...
            expected = helper.defaultPrefilteringData;
            expected.clusteredLightingPrefilteringMode = PrefilteringMode.SelectOnly;
            ...
            expected = helper.defaultPrefilteringData;
            expected.clusteredLightingPrefilteringMode = PrefilteringMode.Select;
            actual = helper.CreatePrefilteringSettings(ShaderFeatures.ForwardPlus);
            helper.AssertPrefilteringData(expected, actual);
