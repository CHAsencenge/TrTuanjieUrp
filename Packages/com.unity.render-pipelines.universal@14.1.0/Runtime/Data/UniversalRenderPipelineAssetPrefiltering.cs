...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset
    {
        ...
        // Forward+
        [FormerlySerializedAs("m_PrefilteringModeForwardPlus")]
        ...
        [SerializeField] private PrefilteringMode m_PrefilteringModeClusteredLighting = PrefilteringMode.Select;
        ...
        // PostProcessing Preserve Alpha
        [ShaderKeywordFilter.RemoveIf(true, keywordNames: ShaderKeywordStrings._PRESERVE_ALPHA)]
        [SerializeField] private bool m_PrefilterPreserveAlpha = false;

        // GPU Resident Drawer Lightmap Single and USE_VTF
        [ShaderKeywordFilter.SelectOrRemove(true, keywordNames: ShaderKeywordStrings.USE_LIGHTMAP_SINGLE)]
        [SerializeField] private bool m_PrefilterUseLightmapSingle = false;

        [ShaderKeywordFilter.RemoveIf(PrefilteringMode.Remove, keywordNames: ShaderKeywordStrings.USE_VTF)]
        [ShaderKeywordFilter.SelectIf(PrefilteringMode.SelectOnly, keywordNames: ShaderKeywordStrings.USE_VTF)]
        [ShaderKeywordFilter.SelectIf(PrefilteringMode.Select, keywordNames: new[] { "", ShaderKeywordStrings.USE_VTF})]
        [SerializeField] private PrefilteringMode m_PrefilterBRGVariantStorageStrip = PrefilteringMode.Remove;
        ...
        {
            public PrefilteringMode clusteredLightingPrefilteringMode;
            ...
            public bool stripPreserveAlphaKeywords;
            ...
            public bool useLightmapSingle;
            public PrefilteringMode brgVariantStorageStripMode;

            public static ShaderPrefilteringData GetDefault()
            {
                return new ShaderPrefilteringData()
                {
                    clusteredLightingPrefilteringMode = PrefilteringMode.Select,
        ...
        {
            m_PrefilteringModeClusteredLighting      = prefilteringData.clusteredLightingPrefilteringMode;
            ...
            m_PrefilterPreserveAlpha                 = prefilteringData.stripPreserveAlphaKeywords;
            ...
            m_PrefilterUseLightmapSingle             = prefilteringData.useLightmapSingle;

            m_PrefilterBRGVariantStorageStrip        = prefilteringData.brgVariantStorageStripMode;
        }
    }
}
#endif
