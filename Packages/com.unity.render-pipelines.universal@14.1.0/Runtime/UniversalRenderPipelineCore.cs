...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal enum ImageUpscalingFilter
    {
        ...
        /// Apple MetalFX Spatial Upscaling
        MetalFXSpatial,

        /// Apple MetalFX temporal AA + upscaling (TAAU)
        MetalFXTemporal,

        /// Tuanjie Super Resolution
        TJSR
    }

    /// <summary>
    /// Enumeration that indicates what kind of temporal post process method is being used
    /// </summary>
    internal enum TemporalMethod
    {
        /// <summary>
        /// Use this option if no valid temporal post process method is used
        /// </summary>
        None = 0,

        /// <summary>
        /// Use this option to apply TemporalAntiAliasing temporal post process
        /// </summary>
        TAA,

        /// <summary>
        /// Use this option to apply Tuanjie Super Resolution temporal post process
        /// </summary>
        TJSR,

        /// <summary>
        /// Use this option to apply Apple MetalFX temporal post process
        /// </summary>
        MetalFXTemporal,
    }
    ...
    public struct CameraData
    {
        ...
        // We store a ref here to avoid calling GetComponent too frequently.
        internal VGShadowData vgShadowData;
#endif
        ...
        {
            return m_JitterMatrix * GL.GetGPUProjectionMatrix(GetProjectionMatrixNoJitter(viewIndex), renderIntoTexture);
        }
        ...
        internal TemporalMethod temporalMethod;
        ...
        /// <summary>
        /// True if this camera preserves alpha channel during post-processing.
        /// </summary>
...
#pragma warning restore 0618
        ...
        /// <summary>
        /// Persistent history data for temporal method, primarily for the accumulation texture.
        /// </summary>
        internal ITemporalPersistentHistory temporalPersistentData;
    ...
    internal static class ShaderPropertyId
    {
        ...
        // For GPU Driven LightProbes
        public static readonly int ambientProbeData = Shader.PropertyToID("_AmbientProbeData");
    }
    ...
    public static class ShaderKeywordStrings
    {
        ...
        internal const string ForwardPlus = "_CLUSTERED_LIGHTING";    // reuse this? or create a new one?
        ...
        /// <summary> Keyword used for preserving alpha channel during post-process.</summary>
        public const string _PRESERVE_ALPHA = "_PRESERVE_ALPHA";
        
        /// <summary> Keyword used for opting out of lightmap texture arrays, when using BatchRendererGroup. </summary>
        public const string USE_LIGHTMAP_SINGLE = "USE_LIGHTMAP_SINGLE";

        /// <summary> Keyword used for opting out of dots instance data in texture, when using BatchRendererGroup. </summary>
        public const string USE_VTF = "USE_VTF";
    }
    ...
    internal enum URPProfileId
    {
        ...
        GPUMotionVectors,
        StencilSplat,
        ExecuteGPUDrivenPipeline,
        DepthPyramidForHZBOC,
        ReflectionProbeAtlas,
        GPUReflectionProbeCull,
