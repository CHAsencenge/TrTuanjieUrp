...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalRendererData : ScriptableRendererData, ISerializationCallbackReceiver
    {
        ...
        public sealed class ShaderResources
        {
            ...
            /// <summary>
            /// Deferred Plus shader.
            /// </summary>
            [Reload("Shaders/Utils/DeferredPlusShading.shader")]
            public Shader deferredPlusPS;
            ...
            /// Shading Rate shader.
            /// </summary>
            [Reload("Shaders/ShadingRate.shader")]
            public Shader shadingRate;
            ...
            /// <summary>
            /// Gpu Driven Motion Vectors shader.
            /// </summary>
            [Reload("Shaders/GpuMotionVectors.shader")]
            public Shader gpuMotionVector;

            /// <summary>
            /// Gpu Driven Stencil Splat shader.
            /// </summary>
            [Reload("Shaders/StencilSplat.shader")]
            public Shader stencilSplat;

            /// <summary>
            /// Gpu Driven generate visibility buffer shader.
            /// </summary>
            [Reload("Shaders/Utils/VisibilityBuffer.shader")]
            public Shader visibilityBuffer;

            /// <summary>
            /// Gpu Driven calculate material depth shader.
            /// </summary>
            [Reload("Shaders/Utils/MaterialDepth.shader")]
            public Shader materialDepth;

            /// <summary>
            /// Gpu Driven calculate rendering layer shader.
            /// </summary>
            [Reload("Shaders/Utils/DecalBufferEmit.shader")]
            public Shader decalBufferEmit;

            /// <summary>
            /// Gpu Driven calculate depth pyramid compute shader.
            /// </summary>
            [Reload("Shaders/Utils/DepthPyramid.compute")]
            public ComputeShader depthPyramid;

            /// <summary>
            /// Gpu Driven calculate Reflection Probe selection compute shader.
            /// </summary>
            [Reload("Shaders/ReflectionProbeCulling.compute")]
            public ComputeShader reflectionProbeCulling;
#endif
