...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderPass
    {
        ...
        {
            get => m_UsesDepthRTHandle ? new RenderTargetIdentifier(m_DepthAttachment.nameID, 0, CubemapFace.Unknown, -1) : m_DepthAttachmentId;
        }
        ...
        internal bool m_UsesDepthRTHandle;
        ...
        /// <summary>
        /// Get the active DebugHandler of RenderingData.
        /// </summary>
        /// <returns>null if there is no DebugHandler, or debugHandler is not active for the CameraData of RenderingData.</returns>
        ...
        /// <summary>
        /// Get the active debugHandler of CameraData.
        /// </summary>
        /// <returns>null if there is no DebugHandler, or debugHandler is not active for the CameraData.</returns>
        internal static DebugHandler GetActiveDebugHandler(ref CameraData cameraData)
        {
        ...
        /// <param name="depthAttachment">Depth attachment identifier.</param>
        /// <seealso cref="Configure"/>
        public void ConfigureTarget(RTHandle[] colorAttachments, RenderTargetIdentifier depthAttachment, GraphicsFormat[] formats)
        {
            m_UsesRTHandles = true;
            m_UsesDepthRTHandle = false;
            overrideCameraTarget = true;
