...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class DebugDisplaySettingsRendering : IDebugDisplaySettingsData
    {
        ...
        /// <summary>
        /// Debug view index provided by TJSR.
        /// <see cref="TJSR.debugViewDescriptions"/>
        /// </summary>
        internal int tjsrDebugViewIndex { get; set; } = 0;
        ...
        /// <summary>
        /// Whether ShadingRateMap is displayed.
        /// </summary>
        public bool showShadingRateMap { get; set; } = true;
        ...
        static class Strings
        {
            ...
            public static readonly NameAndTooltip TjsrDebugViews = new() { name = "TJSR Debug Views", tooltip = "Debug visualizations provided by TJSR." };
            ...
            public static readonly NameAndTooltip ShowShadingRateMap = new() { name = "Show Shading Rate Map", tooltip = "Display color information corresponding to each shading rate value." };
            ...
            public static readonly NameAndTooltip ShadingRateExperimentalWarning = new() { name = "This feature is experimental and will be officially released in a later version!" };
        ...
        internal static class WidgetFactory
        {
            ...
            internal static DebugUI.Widget CreateTjsrDebugViews(SettingsPanel panel) => new DebugUI.EnumField
            {
                nameAndTooltip = Strings.TjsrDebugViews,
                isHiddenCallback = ()=>panel.data.fullScreenDebugMode != DebugFullScreenMode.TJSR,
                enumNames = TJSR.debugViewDescriptions,
                enumValues = TJSR.debugViewIndices,
                getter = () => (int)panel.data.tjsrDebugViewIndex,
                setter = (value) => panel.data.tjsrDebugViewIndex = value,
                getIndex = () => (int)panel.data.tjsrDebugViewIndex,
                setIndex = (value) => panel.data.tjsrDebugViewIndex = value
            };
            ...
            internal static DebugUI.Widget CreateShowShadingRateMap(SettingsPanel panel) => new DebugUI.Container()
            {
                isHiddenCallback = () => panel.data.fullScreenDebugMode != DebugFullScreenMode.ShadingRateValueMap,
                children =
                {
                    new DebugUI.BoolField
                    {
                        nameAndTooltip = Strings.ShowShadingRateMap,
                        getter = () => panel.data.showShadingRateMap,
                        setter = (value) => panel.data.showShadingRateMap = value
                    }
                    
                }
            };
            
            internal static DebugUI.Widget CreateShadingRateExperimentalWarning(SettingsPanel panel) => new DebugUI.MessageBox
            {
                nameAndTooltip = Strings.ShadingRateExperimentalWarning,
                ...
                : base(data)
            {
                ...
                AddWidget(new DebugUI.Foldout
                {
                    ...
                    children =
                    {
                        ...
                        WidgetFactory.CreateTjsrDebugViews(this),
                        WidgetFactory.CreateMapOverlaySize(this),
                        WidgetFactory.CreateShowShadingRateMap(this),
                        WidgetFactory.CreateShadingRateExperimentalWarning(this),
