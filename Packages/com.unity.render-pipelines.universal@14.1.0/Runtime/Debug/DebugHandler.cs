...
namespace UnityEngine.Rendering.Universal
{
    class DebugHandler : IDebugDisplaySettingsQuery
    {
        ...
        readonly Material m_DebugVisibilityMaterial;
        readonly Material m_DebugMaterialIDMaterial;

        HDRDebugViewPass m_HDRDebugViewPass;
#if UNITY_GPU_DRIVEN_PIPELINE
        BufferVisualizationeDebugPass m_BufferVisualizationeDebugPass;
#endif
...
#if UNITY_GPU_DRIVEN_PIPELINE
        internal BufferVisualizationeDebugPass gdrpDebugPass => m_BufferVisualizationeDebugPass;
#endif
        ...
        internal bool GDRPDebugIsActive()
        {
            return GraphicsSettings.enableGDRP;
        }
        ...
        internal int tjsrDebugViewIndex { get { return RenderingSettings.tjsrDebugViewIndex; } }
        ...
        internal DebugHandler(ScriptableRendererData scriptableRendererData)
        {
            ...
            Shader debugVisibilityShader = scriptableRendererData.debugShaders.debugVisibilityShader;
            Shader debugMaterialIDShader = scriptableRendererData.debugShaders.debugMaterialIDShader;
            ...
            m_DebugVisibilityMaterial = (debugVisibilityShader == null) ? null : CoreUtils.CreateEngineMaterial(debugVisibilityShader);
            m_DebugMaterialIDMaterial = (debugMaterialIDShader == null) ? null : CoreUtils.CreateEngineMaterial(debugMaterialIDShader);

            m_HDRDebugViewPass = new HDRDebugViewPass(m_HDRDebugViewMaterial);
#if UNITY_GPU_DRIVEN_PIPELINE
            if (GDRPDebugIsActive())
                m_BufferVisualizationeDebugPass = new BufferVisualizationeDebugPass(m_DebugVisibilityMaterial, m_DebugMaterialIDMaterial);
#endif
        }
        ...
        internal bool TryGetShowShadingRateMap(out bool showShadingRateMap)
        {
            showShadingRateMap = RenderingSettings.showShadingRateMap && RenderingSettings.fullScreenDebugMode == DebugFullScreenMode.ShadingRateValueMap;
            return showShadingRateMap;
        }
