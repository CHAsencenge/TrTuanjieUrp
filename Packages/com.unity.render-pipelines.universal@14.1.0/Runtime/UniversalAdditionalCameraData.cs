...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalAdditionalCameraData : MonoBehaviour, ISerializationCallbackReceiver, IAdditionalData
    {
        ...
        [NonSerialized] TaaPersistentData m_TaaPersistentData;
        [NonSerialized] TjsrPersistentData m_TjsrPersistentData;
#if UNITY_GPU_DRIVEN_PIPELINE
        [NonSerialized] VGShadowData m_VGShadowData = new VGShadowData();

        /// <summary>
        /// VG Shadow data that persists over a frame.
        /// </summary>
        internal VGShadowData vgShadowData => m_VGShadowData;
#endif
        ...
        {
            get => m_TaaPersistentData;
            set => m_TaaPersistentData = value;
        }

        /// <summary>
        /// TJSR buffers and data that persists over a frame.
        /// </summary>
        internal TjsrPersistentData tjsrPersistentData
        {
            get => m_TjsrPersistentData;
            set => m_TjsrPersistentData = value;
        }
        ...
        public void OnDestroy()
        {
            ...
            m_TjsrPersistentData?.DeallocateTargets();
        }
