...
namespace UnityEngine.Rendering.Universal
{
    ...
    {
        // If we enable GDRP's rendering debugger and enter play mode, we need 11 to merge pass.
        private const int kRenderPassMapSize = 11;
        // On MacEditorArm, the max count is 26 instead of 20, after implement VG.
        // private const int kRenderPassMaxCount = 26;
        // After we implement rendering debugger of VG, there're max to 29 passes to render.
        private const int kRenderPassMaxCount = 29;
