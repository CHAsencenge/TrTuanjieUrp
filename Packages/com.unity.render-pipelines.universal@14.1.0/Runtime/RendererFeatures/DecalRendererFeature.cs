...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class DecalRendererFeature : ScriptableRendererFeature
    {
        ...
        internal DecalTechnique GetTechnique(ScriptableRendererData renderer)
        {
            ...
            var isDeferred = universalRenderer.renderingMode is RenderingMode.Deferred or RenderingMode.DeferredPlus;
        ...
        internal DecalTechnique GetTechnique(ScriptableRenderer renderer)
        {
            ...
            var isDeferred = universalRenderer.renderingModeActual is RenderingMode.Deferred or RenderingMode.DeferredPlus;
            return GetTechnique(isDeferred, universalRenderer.accurateGbufferNormals);
        }
        ...
        public override void SetupRenderPasses(ScriptableRenderer renderer, in RenderingData renderingData)
        {
            ...
            if (m_Technique == DecalTechnique.DBuffer)
            {
                ...
                var universalRenderer = renderer as UniversalRenderer;
                if (universalRenderer.renderingModeActual is RenderingMode.Deferred or RenderingMode.DeferredPlus)
                {
