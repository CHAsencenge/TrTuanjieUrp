...
#define _PrevViewProjM  _PrevViewProjMStereo[unity_StereoEyeIndex]
        ...
        TEXTURE2D_X(_ObjectMotionBlurTex);
        ...
        half4 VelocityOffsetSample(float2 uv, int iterations, half2 velocity)
        {
            ...
            #else
                return half4(color.rgb * invSampleCount, 1.0);
            #endif
        }
        
        half4 DoCameraMotionBlur(VaryingsCMB input, int iterations)
        {
            ...
            return VelocityOffsetSample(uv, iterations, velocity);
        }

        half4 DoObjectAndCameraMotionBlur(VaryingsCMB input, int iterations)
        {
            UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input);
            
            float2 uv = UnityStereoTransformScreenSpaceTex(input.texcoord.xy);
            half2 velocity = SAMPLE_TEXTURE2D_X(_ObjectMotionBlurTex, sampler_PointClamp, uv).xy;

            velocity = -ClampVelocity(velocity, _Clamp) * _Intensity * 2.0f;
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                ...
                #pragma multi_compile_fragment _ _PRESERVE_ALPHA

                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoCameraMotionBlur(input, 2);
                }
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                ...
                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoCameraMotionBlur(input, 3);
                }
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                ...
                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoCameraMotionBlur(input, 4);
                }
        ...
        Pass
        {
            Name "Object Motion Blur - Low Quality"
            ...
            HLSLPROGRAM
                ...
                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoObjectAndCameraMotionBlur(input, 2);
                }
        ...
        Pass
        {
            Name "Object Motion Blur - Medium Quality"
            ...
            HLSLPROGRAM
                ...
                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoObjectAndCameraMotionBlur(input, 3);
                }
        ...
        Pass
        {
            Name "Object Motion Blur - High Quality"
            ...
            HLSLPROGRAM
                ...
                half4 FragCMB(VaryingsCMB input) : SV_Target
                {
                    return DoObjectAndCameraMotionBlur(input, 4);
                }
