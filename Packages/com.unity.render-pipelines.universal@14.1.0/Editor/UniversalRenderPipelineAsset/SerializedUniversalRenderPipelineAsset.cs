...
namespace UnityEditor.Rendering.Universal
{
    internal class SerializedUniversalRenderPipelineAsset
    {
        ...
        public SerializedProperty advancedUpscalingFilterList { get; }
        public SerializedProperty TJSRSettings { get; }
        public SerializedProperty MetalFXMode { get; }
        ...
        public SerializedProperty reflectionProbeAtlasResolutionProp { get; }
        ...
        public SerializedProperty gpuResidentDrawerStat { get; }
        public SerializedProperty grdEnableColletTransform { get; }
        public SerializedProperty grdEnableColletLightMap { get; }
        public SerializedProperty grdEnableColletLightProbe { get; }
        public SerializedProperty grdEnableColletMotionVector { get; }
        public SerializedProperty brgShaderVariantStorageStripType { get; }

        public SerializedProperty grdUseTextureStoreData { get; }

        public SerializedProperty postProcessPreserveAlpha { get; }
        ...
        public SerializedUniversalRenderPipelineAsset(SerializedObject serializedObject)
        {
            ...
            advancedUpscalingFilterList = serializedObject.FindProperty("m_AdvancedUpscalingFilterList");
            TJSRSettings = serializedObject.FindProperty("m_TJSRSettings");
            MetalFXMode = serializedObject.FindProperty("m_MetalFXMode");
            ...
            reflectionProbeAtlasResolutionProp = serializedObject.FindProperty("m_ReflectionProbeAtlasResolution");
            ...
            postProcessPreserveAlpha = serializedObject.FindProperty("m_PostProcessPreserveAlpha");
            
            gpuResidentDrawerStat = serializedObject.FindProperty("m_GPUResidentDrawerStat");
            grdEnableColletTransform = serializedObject.FindProperty("m_GRDEnableCollectTransform");
            grdEnableColletLightMap = serializedObject.FindProperty("m_GRDEnableCollectLightMap");
            grdEnableColletLightProbe = serializedObject.FindProperty("m_GRDEnableCollectLightProbe");
            grdEnableColletMotionVector = serializedObject.FindProperty("m_GRDEnableCollectMotionVector");
            brgShaderVariantStorageStripType = serializedObject.FindProperty("m_BRGShaderVariantStorageStripType");
            grdUseTextureStoreData = serializedObject.FindProperty("m_GRDUseTextureStoreData");
