...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class UniversalRenderPipelineAssetEditor : Editor
    {
        ...
        internal ReorderableList upscalingFilterDataList
        {
            get => m_UpscalingFilterDataList;
            set => m_UpscalingFilterDataList = value;
        }
        ReorderableList m_UpscalingFilterDataList;
