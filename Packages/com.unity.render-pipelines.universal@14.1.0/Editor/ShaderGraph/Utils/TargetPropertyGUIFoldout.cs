...
{
    class TargetPropertyGUIFoldout : Foldout
    {
        ...
        public void ApplyIndent(int indentLevel)
        {
            this.style.marginLeft = (globalIndentLevel + indentLevel) * kIndentWidthInPixel;
        }
        public void ApplyIndent(int indentLevel, int rightIndentLevel = 0)
        {
            this.style.marginLeft = (globalIndentLevel + indentLevel) * kIndentWidthInPixel;
            this.style.marginRight = (globalIndentLevel + rightIndentLevel) * kIndentWidthInPixel;
        }
