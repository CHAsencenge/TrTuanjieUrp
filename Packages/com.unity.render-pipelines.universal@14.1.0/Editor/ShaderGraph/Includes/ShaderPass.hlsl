...
#define SHADERPASS_GBUFFER_SPLAT (23)
#define SHADERPASS_VBUFFER_ALPHA_CLIP (24)
#define SHADERPASS_ALPHA_MESH_SELECTION (25)
#define SHADERPASS_VGSHADOWMAP_ALPHA_CLIP (26)
