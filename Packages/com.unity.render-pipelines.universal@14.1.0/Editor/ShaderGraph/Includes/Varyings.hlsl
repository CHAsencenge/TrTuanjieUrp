...
VertexDescription BuildVertexDescription(Attributes input, AttributesElement element UNITY_GDRP_INSTANCE_PARAMETER UNITY_GDRP_INSTANCE_ID_PARAMETER, out GraphProperties properties )
{
    ...
    VertexDescription vertexDescription = VertexDescriptionFunction(vertexDescriptionInputs UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT, properties);
    return vertexDescription;
}
#else
VertexDescription BuildVertexDescription(Attributes input UNITY_GDRP_INSTANCE_PARAMETER UNITY_GDRP_INSTANCE_ID_PARAMETER)
{
    // Evaluate Vertex Graph
    VertexDescriptionInputs vertexDescriptionInputs = BuildVertexDescriptionInputs(input);
    VertexDescription vertexDescription = VertexDescriptionFunction(vertexDescriptionInputs UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT);
    return vertexDescription;
}
#endif
#endif
...
Varyings BuildVaryings(Attributes input
    ...
    UNITY_GDRP_INSTANCE_ID_PARAMETER
)
{
    ...
    VertexDescription vertexDescription = BuildVertexDescription(input, element UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT, properties);
#else
    VertexDescription vertexDescription = BuildVertexDescription(input UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT);
#endif
...
SurfaceDescription BuildSurfaceDescription( Varyings varyings 
                                            ...
                                            UNITY_GDRP_MATRIX_M_PARAMETER 
                                            UNITY_GDRP_MATRIX_M_I_PARAMETER 
                                            UNITY_GDRP_ATTRIBUTE_PARAMETER)
{
    SurfaceDescriptionInputs surfaceDescriptionInputs = BuildSurfaceDescriptionInputs(varyings UNITY_GDRP_MATRIX_M_ARGUMENT UNITY_GDRP_MATRIX_M_I_ARGUMENT UNITY_GDRP_ATTRIBUTE_ARGUMENT);
#if defined(HAVE_VFX_MODIFICATION)
    GraphProperties properties;
    ZERO_INITIALIZE(GraphProperties, properties);
    GetElementPixelProperties(surfaceDescriptionInputs, properties);
    SurfaceDescription surfaceDescription = SurfaceDescriptionFunction(surfaceDescriptionInputs UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT, properties);
#else
    SurfaceDescription surfaceDescription = SurfaceDescriptionFunction(surfaceDescriptionInputs UNITY_GDRP_INSTANCE_ARGUMENT UNITY_GDRP_INSTANCE_ID_ARGUMENT UNITY_GDRP_MATERIAL_PAGE_OFFSET_ARGUMENT);
#endif
