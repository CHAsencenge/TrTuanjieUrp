...
namespace UnityEditor.Rendering.Universal
{
    internal static class Property
    {
        ...
        public static readonly string StencilWriteMaskGBufferURP = "_StencilWriteMaskGBufferURP";
        public static readonly string StencilRefGBufferURP = "_StencilRefGBufferURP";
        public static readonly string ZClip = "_ZClip";
        // Shading Features
        public static readonly string ShadingFeatuers = "_ShadingFeatures";

        // Fabric Type
        public static readonly string FabricType = "_FabricType";

        public static readonly string UsePreIntegratedFDG = "_UsePreIntegratedFDG";
    }
}
