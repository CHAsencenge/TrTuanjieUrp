...
namespace UnityEngine.Rendering
{
    ...
    public static class CoreUtils
    {
        ...
        public static void SetRenderTarget(CommandBuffer cmd, RTHandle buffer, 
            RenderBufferLoadAction loadAction, RenderBufferStoreAction storeAction, RenderBufferLoadAction depthLoadAction, RenderBufferStoreAction depthStoreAction,
            ClearFlag clearFlag, Color clearColor)
        {
            SetRenderTarget(cmd, buffer.nameID, loadAction, storeAction, depthLoadAction, depthStoreAction, clearFlag, clearColor);
        }
