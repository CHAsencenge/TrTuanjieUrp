...
#include "Packages/com.tr.render/CoreShaderLibrary/Common.hlsl"
#include "Packages/com.tr.render/CoreShaderLibrary/Shadow/ShadowSamplingTent.hlsl"
#include "Packages/com.tr.render/CoreShaderLibrary/GlobalSamplers.hlsl"
#include "Core.hlsl"
...
#define SHADOWMASK_SAMPLE_EXTRA_ARGS
    ...
    #undef SAMPLE_SHADOWMASK
#if defined(SHADOWS_SHADOWMASK) && defined(LIGHTMAP_ON)
    #define SAMPLE_SHADOWMASK(uv, ddx, ddy) SAMPLE_TEXTURE2D_LIGHTMAP(SHADOWMASK_NAME, SHADOWMASK_SAMPLER_NAME, uv SHADOWMASK_SAMPLE_EXTRA_ARGS, ddx * unity_LightmapST.xy, ddy * unity_LightmapST.xy);
#elif !defined (LIGHTMAP_ON)
    #define SAMPLE_SHADOWMASK(uv, ddx, ddy) unity_ProbesOcclusion;
#else
    #define SAMPLE_SHADOWMASK(uv, ddx, ddy) half4(1, 1, 1, 1);
#endif
#endif
