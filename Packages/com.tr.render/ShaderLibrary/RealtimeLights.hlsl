...
#include "Packages/com.tr.render/ShaderLibrary/LightCookie/LightCookie.hlsl"
#include "Packages/com.tr.render/ShaderLibrary/Clustering.hlsl"
...
#if !defined(_USE_WEBGL1_LIGHTS) && (defined(UNITY_PLATFORM_WEBGL) || defined(UNITY_PLATFORM_WEIXINMINIGAME)) && !defined(SHADER_API_GLES3)
