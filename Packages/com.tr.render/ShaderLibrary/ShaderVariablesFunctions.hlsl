...
#include "Packages/com.tr.render/ShaderLibrary/ShaderVariablesFunctions.deprecated.hlsl"
...
{
// VG's alpha test is completed by another pass.
#if defined(_ALPHATEST_ON) && !defined(UNITY_GPU_DRIVEN_PIPELINE)
