...
#if defined(_CLUSTERED_LIGHTING)
...
#include "Packages/com.tr.render/CoreShaderLibrary/Version.hlsl"
#include "Packages/com.tr.render/ShaderLibrary/Input.hlsl"
...
// @TODO: SLICE_ARRAY_INDEX have already been defined in GPUDrivenCommon.hlsl by VG.
// So here we should #undef. We may re-write this for XR later.
#undef SLICE_ARRAY_INDEX
// Stereo-related bits
...
#include "Packages/com.tr.render/ShaderLibrary/ShaderVariablesFunctions.hlsl"
