...
#include "Packages/com.tr.render/CoreShaderLibrary/API/D3D11.hlsl"
#elif defined(SHADER_API_METAL)
#include "Packages/com.tr.render/CoreShaderLibrary/API/Metal.hlsl"
#elif defined(SHADER_API_VULKAN)
#include "Packages/com.tr.render/CoreShaderLibrary/API/Vulkan.hlsl"
#elif defined(SHADER_API_SWITCH)
#include "Packages/com.tr.render/CoreShaderLibrary/API/Switch.hlsl"
#elif defined(SHADER_API_GLCORE)
#include "Packages/com.tr.render/CoreShaderLibrary/API/GLCore.hlsl"
#elif defined(SHADER_API_GLES3)
#include "Packages/com.tr.render/CoreShaderLibrary/API/GLES3.hlsl"
#elif defined(SHADER_API_GLES)
#include "Packages/com.tr.render/CoreShaderLibrary/API/GLES2.hlsl"
#else
#error unsupported shader api
#endif
#include "Packages/com.tr.render/CoreShaderLibrary/API/Validate.hlsl"

#include "Packages/com.tr.render/CoreShaderLibrary/Macros.hlsl"
#include "Packages/com.tr.render/CoreShaderLibrary/Random.hlsl"
...
#define UNITY_DEFINE_PROP(type, name, reg) type name;
// ----------------------------------------------------------------------------
...
#include "Packages/com.tr.render/CoreShaderLibrary/CommonDeprecated.hlsl"
...
float4x4 Inverse(float4x4 m)
{
    ...
    float idet = 1.0f / (abs(det) < FLT_EPS ? sign * FLT_EPS : det);
...
#define UNITY_GDRP_INSTANCE_UNIQUE_PARAMETER
#define UNITY_GDRP_INSTANCE_UNIQUE_ARGUMENT
#define UNITY_GDRP_INSTANCE_PARAMETER
#define UNITY_GDRP_INSTANCE_ARGUMENT
#define UNITY_GDRP_INSTANCE_ID_PARAMETER
#define UNITY_GDRP_INSTANCE_ID_ARGUMENT
#define UNITY_GDRP_INSTANCE_ZERO_ARGUMENT
...
#define UNITY_GDRP_MATRIX_M_PARAMETER
#define UNITY_GDRP_MATRIX_M_ARGUMENT
#define UNITY_GDRP_MATRIX_M_I_PARAMETER
#define UNITY_GDRP_MATRIX_M_I_ARGUMENT
#define UNITY_GDRP_ATTRIBUTE_PARAMETER
#define UNITY_GDRP_ATTRIBUTE_ARGUMENT
#define UNITY_GDRP_PROBE_INDEX_PARAMETER
#define UNITY_GDRP_PROBE_INDEX_ARGUMENT
#define UNITY_GDRP_PROBE_INDEX_ZERO_ARGUMENT
