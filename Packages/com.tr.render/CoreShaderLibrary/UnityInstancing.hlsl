...
// instanced property arrays
    ...
    #include "Packages/com.tr.render/CoreShaderLibrary/UnityDOTSInstancing.hlsl"
    #if defined(UNITY_SETUP_INSTANCE_ID)
...
#if defined(USE_VTF)
        #define UNITY_DOTS_MATRIX_M        LoadObjectToWorldMatrixFromTex(UNITY_DOTS_INSTANCED_METADATA_NAME(float3x4, unity_ObjectToWorld))
        #define UNITY_DOTS_MATRIX_I_M      LoadWorldToObjectMatrixFromTex(UNITY_DOTS_INSTANCED_METADATA_NAME(float3x4, unity_WorldToObject))
#else
